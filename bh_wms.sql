...
-- ----------------------------
BEGIN;
INSERT INTO `department` VALUES (1, '大丰科技股份有限公司', 1, 0, '2022-11-02 05:07:47', '2022-11-01 21:07:48', 1);
INSERT INTO `department` VALUES (2, '大丰科技(北京分公司)', 2, 1, '2022-11-02 05:07:55', '2022-11-01 21:08:16', 1);
INSERT INTO `department` VALUES (3, '人事部', 3, 2, '2022-11-02 05:08:25', '2022-11-01 21:08:26', 1);
INSERT INTO `department` VALUES (4, '行政部', 3, 2, '2022-11-02 05:08:40', '2022-11-01 21:08:41', 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `role` VALUES (1, '平台管理员', '2022-11-02 05:06:47', '2022-11-01 21:06:48', 1);
INSERT INTO `role` VALUES (2, '仓库管理员', '2022-11-02 05:07:02', '2022-11-01 21:07:03', 1);
COMMIT;
...
CREATE TABLE `user` (
  ...
  `DEPT_ID` int(11) DEFAULT NULL COMMENT '部门ID,关联部门表主键',
  `CREATE_TIME` datetime DEFAULT NULL COMMENT '创建时间',
  `UPDATE_TIME` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '设置当前时间，并且自动更更新时间',
  `IS_DELETE` int(11) DEFAULT '1' COMMENT '是否删除 0:删除 1:未删除',
  PRIMARY KEY (`USER_ID`),
